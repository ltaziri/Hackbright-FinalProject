...
def example_data():
    ...
    uga = UserGroup(usergroup_id = 1, group_id = 1, user_id = 1)
    ugb = UserGroup(usergroup_id = 2, group_id = 2, user_id = 1)
    ugc = UserGroup(usergroup_id = 3, group_id = 3, user_id = 1)
    ugd = UserGroup(usergroup_id = 4, group_id = 1, user_id = 2)
    uge = UserGroup(usergroup_id = 5, group_id = 2, user_id = 2)
    ugf = UserGroup(usergroup_id = 6, group_id = 3, user_id = 3)
    ...
    db.session.add_all([ua, ub, ub, uga, ugb, ugc, ugd, uge, ugf, ga, gb, ca, cb, ia, ib])
    db.session.commit()
